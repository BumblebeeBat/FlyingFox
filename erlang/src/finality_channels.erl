...
-record(channel, {delay = 10, bal1 = 0, bal2 = 0, consensus_flag = false, addressInt1 = 1, addressInt2 = 2, creationBlockNumber = 1}).
% delay 10, balance1 48, balance2 48, consensus_flag 1, addressInt1 30, addressInt2 30, creationBlockNumber 38. sums to 205
-define(word, 205).
init(ok) -> {ok, []}.
...
read(N) -> 
    ...
    #channel{delay = Delay, bal1 = Bal1, bal2 = Bal2, consensus_flag = ConsensusFlag, addressInt1 = AddressInt1, addressInt2 = AddressInt2, creationBlockNumber = CreationBlockNumber}.
...
write(N, Ch) ->
    Val = << (Ch#channel.delay):10, 
             ...
             (Ch#channel.addressInt1):30, 
             (Ch#channel.addressInt2):30, 
