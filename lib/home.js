...
function unlocked() {
    ...
    window.setInterval(refresh_server_status, 1000);
    refresh_inbox_peers();
    window.setInterval(refresh_inbox_peers, 2000);
    refresh_channel_peers();
    window.setInterval(refresh_channel_peers, 2000);
    ...
    refresh_mail_nodes();
    window.setInterval(refresh_mail_nodes, 2000);
    refresh_txs();
