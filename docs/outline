...
Create channel:
This creates a 2-way channel between 2 people. It allows them to give money to each other without writing anything onto the blockchain.

Channel spend:
This is how you spend money without writing on the blockchain.
