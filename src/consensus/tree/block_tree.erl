...
test() -> 
    ...
    ChannelHashlock11 = channel_manager:hashlock(24001, ChannelHashlock01, -30, SH, 1),
    SignedChannelHashlock11 = sign_tx( sign_tx(ChannelHashlock11, Pub, Priv), Pub2, Priv2),
    SignedChannelHashlock21 = sign_tx(channel_timeout_tx:timeout_channel(2, sign:set_revealed(SignedChannelHashlock11, [[hash:doit(1)]])), Pub2, Priv2),
    ...
    SignedChannelHashlock12 = sign_tx( sign_tx(ChannelHashlock12, Pub, Priv), Pub2, Priv2),
    SignedChannelHashlock22 = sign_tx(channel_timeout_tx:timeout_channel(2, sign:set_revealed(SignedChannelHashlock12, [[hash:doit(1)]])), Pub2, Priv2),
    %Two problems here. 
    ...
    CloseHashlock11 = sign_tx(CloseHashlock01, Pub2, Priv2),
    ...
    CloseHashlock12 = sign_tx(CloseHashlock02, Pub2, Priv2),
