...
test() -> 
    ...
    create_account_tx:create_account(Pub2, 648000),
    buy_block(),
    reveal:reveal(),
    sign_tx:sign(),
    %CreateTxz = to_channel_tx:create_channel(2, 10000000, 1, delegated_2, 0),
    %SignedCreateTxz = sign_tx(CreateTxz, Pub2, Priv2),
    %tx_pool:absorb(SignedCreateTxz),
