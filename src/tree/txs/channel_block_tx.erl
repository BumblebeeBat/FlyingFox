...
doit(SignedTx, ParentKey, Channels, Accounts) ->
    ...
    %the process of extracting data from the origin tx needs to be moved to a different file. The same process is used in to_channel to update the channel state.
